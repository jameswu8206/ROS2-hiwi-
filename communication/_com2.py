...
class Robot2(Node):
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Communicate, 'edge23', 10)
        self.subscription=self.create_subscription(Communicate, 'edge32',self.listener_callback, 10)
